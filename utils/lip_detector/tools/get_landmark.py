...
from base import cores_root_dir
from cores.digital_human.dataset.data_utils.detect_face import SCRFD
from cores.digital_human.module.pfld_mobileone import PFLD_GhostOne as PFLDInference
...
class Landmark:
    def __init__(self):
        mean_face_path = os.path.join(cores_root_dir,'digital_human','dataset','data_utils','mean_face.txt')
        ...
        kps_onnx_path = os.path.join(cores_root_dir,'digital_human','dataset','data_utils','scrfd_2.5g_kps.onnx')
        self.det_net = SCRFD(kps_onnx_path, confThreshold=0.1, nmsThreshold=0.5)
        checkpoint_epoch_335_path = os.path.join(cores_root_dir,'digital_human','dataset','data_utils','checkpoint_epoch_335.pth.tar')
        checkpoint = torch.load(checkpoint_epoch_335_path)
